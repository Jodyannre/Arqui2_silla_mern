    ...
    if(this.state._id) {
      fetch(`/api/tasks/${this.state._id}`, {
        ...
        .then(data => {
          ...
          this.setState({_id: '', title: '', description: '', numero:0,dia:0});
          this.fetchTasks();
        });
    } else {
      fetch('/api/tasks', {
        ...
        .then(data => {
          ...
          this.setState({title: '', description: '', numero:0,dia:0});
          this.fetchTasks();
        })
              ...
              <div className="card">
                <div className="card-content">
                  <form onSubmit={this.addTask}>
                    ...
                    <div className="row">
                      <div className="input-field col s12">
                        <textarea name="numero" onChange={this.handleChange} value={this.state.numero} cols="30" rows="10" placeholder="Task numero" className="materialize-textarea"></textarea>
                      </div>
                    </div>
                    <div className="row">
                      <div className="input-field col s12">
                        <textarea name="dia" onChange={this.handleChange} value={this.state.dia} cols="30" rows="10" placeholder="Task dia" className="materialize-textarea"></textarea>
                      </div>
                    </div>
